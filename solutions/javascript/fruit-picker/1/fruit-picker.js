...
export function orderFromGrocer(query, onSuccessCallback, onErrorCallback) {
  ...
  let orderResponse = order(query,onSuccessCallback,onErrorCallback);
}
...
export function postOrder(variety, quantity) {
  ...
  let instQuery = { "variety" : variety, "quantity" : quantity};
  console.log(instQuery);

  return orderFromGrocer( instQuery, onSuccess, onError );
}
