 ...
 */
export function totalTimeInMinutes(NUM_LAYERS, actualMinutesInOven) {
  let totalTimeInMinutes = (NUM_LAYERS*2) + actualMinutesInOven;
  return totalTimeInMinutes;
}

let remainingTime = remainingMinutesInOven(TIME_IN_OVEN);
let prepTime = preparationTimeInMinutes(NUM_LAYERS);
let totalTime = totalTimeInMinutes(NUM_LAYERS, TIME_IN_OVEN);

console.log( "Remaining : " + remainingTime );
console.log( "Total Prep : " + prepTime );
